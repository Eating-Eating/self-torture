export const dirOutput = {
  ...
  keyWords: [
    ...
    },
    {
      ...
      keyWords: [
        '新老架构对比','class组件与functional component对比',
        {
          label: 'diff',
        ...
        },
        {
          ...
          keyWords: ['fiber reconciler','fiber node','fiber linked list','fiber tree','数据结构']
        },
        {
          label: 'hooks',
    ...
    },
    {
      ...
      keyWords: [
        '构建dom树','构建cssom树','渲染','Style','Layout','Paint','Compositing','交互',"重绘","重排","提升合成层","GUI渲染线程","JS引擎线程","事件触发线程","定时触发器线程","异步http请求线程","ssr","csr","同构",
        {
          label: 'cookie',
        ...
        },
        {
          ...
          keyWords: [
            "堆栈","主副垃圾回收","Scavenge标记-复制","Mark-Sweep标记清除", "Mark-Compact标记整理","标记","独写屏障","错误定位",
            {
              label: 'memoryLeak',
