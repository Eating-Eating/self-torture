...
<Route path="/projects" key="/projects" exact>{AsyncCompoennt(import("./pages/markdown/projects/index.md"))}</Route>
...
<Route path="/webBrowser/crossPage" key="/webBrowser/crossPage" exact>{AsyncCompoennt(import("./pages/markdown/webBrowser/crossPage/index.md"))}</Route>
...
<Route path="/webBrowser/garbageCycle" key="/webBrowser/garbageCycle" exact>{AsyncCompoennt(import("./pages/markdown/webBrowser/garbageCycle/index.md"))}</Route>
...
<Route path="/webBrowser/safety" key="/webBrowser/safety" exact>{AsyncCompoennt(import("./pages/markdown/webBrowser/safety/index.md"))}</Route>
...
<Route path="/webpack" key="/webpack" exact>{AsyncCompoennt(import("./pages/markdown/webpack/index.md"))}</Route>
